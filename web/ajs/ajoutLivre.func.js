...
/*********************** CASE A COCHER JE NE SUIS PAS UN ROBOT DANS LE FORMULAIRE *********************/
    // Désactiver le bouton par défaut
/*    $("button[type=submit]").attr("disabled", "disabled");
    // Désactiver ou activer le bouton en cochant la case
function ValideForm(frm) {
	if(document.getElementById('btnaccepte').checked == true)          {document.getElementById('envoyer').disabled = false }
